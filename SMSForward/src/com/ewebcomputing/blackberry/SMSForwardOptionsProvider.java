...
class SMSForwardOptionsProvider implements OptionsProvider {

	private ObjectChoiceField styleChoice;
	private EditField email;
	private SMSForwardProperties optionProperties;
	private SMSForward app = null;

	public SMSForwardOptionsProvider(SMSForward theApp) {
		app = theApp;
	}
	...
	public void populateMainScreen(MainScreen mainScreen) {
		optionProperties = SMSForwardProperties.fetch();
